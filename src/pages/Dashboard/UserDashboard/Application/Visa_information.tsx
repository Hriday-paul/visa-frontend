...
import { addVisaInfo } from "../../../../Redux/Slices/Application_infoSlice";
...
export default function Visa_information() {
    ...
    const handleAddVisaInfo: SubmitHandler<Visa_information_types> = (data) => {
        dispatch(addVisaInfo(data))
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark my-8">
            ...
            <form className="p-6.5" onSubmit={handleSubmit(handleAddVisaInfo)}>
